...
public class CurrencyManager : Singleton<CurrencyManager>
{
    ...
    public void IncreaseCurrencyCount(CurrencyItemType currencyItemType, int amount, float duration=0.5f)
    {
        CurrencyItem currencyItem = currencyItemsList.Find(x => x.currencyItemType == currencyItemType);
        currencyItem.ChangeAmount(currencyItem.targetCount + amount, duration);
    }
